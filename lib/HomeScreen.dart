...
import 'package:rent_app/SearchProduct.dart';
import 'package:rent_app/Welcome/welcome_screen.dart';
import 'package:rent_app/globalVar.dart';
import 'package:rent_app/imageSliderScreen.dart';
import 'package:rent_app/profileScreen.dart';
import 'package:rent_app/uploadAdScreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<bool> showDialogForUpdateData(selectedDoc, oldUserName, oldPhoneNumber, oldItemPrice, oldItemName, oldItemDescription) async{
    return showDialog(
        context: context,
  ...
  getUserAddress() async{
    ...
    String newCompleteAddress = '${placemark.subThoroughfare} ${placemark.thoroughfare}, ${placemark.subThoroughfare} ${placemark.locality}, ${placemark.subAdministrativeArea}, ${placemark.administrativeArea} ${placemark.postalCode}, ${placemark.country}';
